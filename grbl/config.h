...
#define X_STEP_BIT         5  // Nano Digital Pin 2
#define Y_STEP_BIT         6  // Nano Digital Pin 3
#define Z_STEP_BIT         7  // Nano Digital Pin 4
#define X_DIRECTION_BIT    2  // Nano Digital Pin 5
#define Y_DIRECTION_BIT    3  // Nano Digital Pin 6
#define Z_DIRECTION_BIT    4  // Nano Digital Pin 7
